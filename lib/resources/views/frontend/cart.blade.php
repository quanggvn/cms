						...
						<div id="list-cart">
							...
							<form>
								<table class="table table-bordered .table-responsive text-center">
									...
									<tr>
										<td><img width="250px" class="img-responsive" src="{{asset('lib/storage/app/avatar/'
										.$item->options->img)}}"></td>
										<td>{{$item->name}}</td>
										<td>
										...
										<td><a onclick="return confirm('Xóa sản phẩm?')" class="btn btn-warning" href="{{asset('cart/delete/'.$item->rowId)}}">Xóa</a></td>
									</tr>
                                        @endforeach
								</table>
